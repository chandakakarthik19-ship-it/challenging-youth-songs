...
export default function Home() {
  ...
  return (
    <main className="min-h-screen pb-32">
      ...
      <button aria-label="Play next song" title="Next song" onClick={playNextSong} disabled={!activeSong || !filteredSongs.length} className="fixed bottom-8 right-8 z-10 grid h-12 w-12 place-items-center rounded-full bg-[#17221c] text-white shadow-xl transition hover:scale-105 hover:bg-[#2f6849] disabled:cursor-not-allowed disabled:opacity-40"><SkipForward size={18} fill="currentColor" /></button>
